...
class Visit {
    ...
    show(id) {
        ...
        let text = `  
                ...
                <td>
                  <a href="/doctor/submitappointment/${this.visit_id}" target="_blank"><button>Submit visit<span class="las la-arrow-right"> </span></button></a>
                </td>
              `
...
function submitApoointment(id) {
    let visitid = visits[id].getVisidId()
    postData('post', '/doctor/submitappointments', {
        id: visitid,
    })
        .then(data => {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    postData('POST', '/doctor/appointments', {
...
function submitAppointment() {
    ...
    postData('post','/doctor/makeappointments', {
      name:name,
      email:email,
