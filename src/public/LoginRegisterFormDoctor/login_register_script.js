        ...
        .then(data => {
            ...
            if (data.message == 'ok') {
                Swal.fire({
                    ...
                    html:
                        'Mozesz <a href="localhost:3000/LoginRegisterFormDoctor">zalogowac</a> sie do serwisu!',
                ...
                Swal.fire({
                    ...
                    text: 'Skontaktuj sie z administratorem',
                    icon: 'error',
                    confirmButtonText: 'Ok'
